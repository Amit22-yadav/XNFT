...
pub mod pallet {
	...
	pub struct CollectionWrapper<T: Config<I>, I: 'static = ()>(sp_std::marker::PhantomData<(T, I)>);

impl<T: Config<I>, I: 'static> CollectionWrapper<T, I> {
    pub fn get_collection(collection_id: T::CollectionId) -> Option<CollectionDetails<T::AccountId, DepositBalanceOf<T, I>>> {
